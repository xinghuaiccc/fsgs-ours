...
from dngs.scene import Scene
import os
from tqdm import tqdm
from os import makedirs
from dngs.gaussian_renderer import render_sh
import torchvision
from dngs.utils.general_utils import safe_state
from argparse import ArgumentParser
from dngs.arguments import ModelParams, PipelineParams, get_combined_args
from dngs.gaussian_renderer import GaussianModelSH
...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress", ascii=True, dynamic_ncols=True)):
        ...
        torchvision.utils.save_image(render_pkg['alpha'], os.path.join(depth_path, 'aplha_{0:05d}'.format(idx) + ".png"))
